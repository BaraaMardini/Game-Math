...
**Math Game** is a Windows Forms desktop application developed in C#. The game helps users improve arithmetic skills with a fun and interactive interface.

## Features

- Supports addition, subtraction, multiplication, division, or mixed operations.
...
- Timer countdown for each question to challenge the user.
...
4. Click 'Next Question' or let the timer run out to proceed.
...
*(Add screenshots of the game UI here if possible)*
